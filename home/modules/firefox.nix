    ...
    profiles.chayleaf = lib.mkMerge [
      {
        ...
        settings =
          let
            ...
            genFonts =
              prefix: func:
              lib.genAttrs (map (lang: "font.name.${prefix}.${lang}") langs) (
            ...
            notoFamilies = {
              ...
              zh-TW = "CJK TC";
              # cyrillic = "Cyrillic";
              x-devanagari = "Devanagari"; # el = "Greek";
              x-ethi = "Ethiopic";
              x-geor = "Georgian";
              x-gujr = "Gujarati";
              x-guru = "Gurmukhi";
          ...
          in
          genFonts "monospace" (_: "Noto Sans Mono")
          // genFonts "sans-serif" (
            lang: if notoFamilies ? ${lang} then "Noto Sans ${notoFamilies.${lang}}" else "Noto Sans"
          )
          // genFonts "serif" (
            lang: if notoFamilies ? ${lang} then "Noto Serif ${notoFamilies.${lang}}" else "Noto Serif"
          )
          // {
