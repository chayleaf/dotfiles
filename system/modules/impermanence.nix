        ...
        map
          (
            ...
            if builtins.isPath x then
              toString x
            else if builtins.isPath (x.directory or null) then
          ...
          (
            ...
            ++
              lib.optionals
                (
                  builtins.any (x: x.useDHCP != false) (builtins.attrValues config.networking.interfaces)
      ...
      files =
        map
          (
            ...
            if builtins.isPath x then
              toString x
            else if builtins.isPath (x.file or null) then
              x // { file = toString x.file; }
            else
              x
          )
          (
